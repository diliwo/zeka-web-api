...
namespace Client.Application.Supports.Commands.UpsertSupport
{
        ...
        public UpsertSupportCommandValidator(IRepositoryManager repository)
        {
            ...
            When(suppot => suppot.SupportId == null, () =>
            {
                RuleFor(v => v.StartDate)
                    ...
                    {
                        bool result = await _repository.Support.DateIsEarlierThanExistingDates(obj.ClientId, date);
                        return !result;
            ...
            When(suppot => suppot.SupportId != null, () =>
            {
                RuleFor(v => v.StartDate)
                    ...
                    {
                        bool result =
                            await _repository.Support.DateIsEarlierThanExistingDates(obj.ClientId, date,
                               (int) obj.SupportId);
                        return !result;
