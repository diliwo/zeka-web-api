...
public sealed class TenantHttpTests
{
    ...
    public async Task Authentication_requires_a_valid_signature_issuer_audience_and_lifetime(string invalid)
    {
        ...
        AdminAreaManagement.API.TenantAuthentication.AddTenantAuthentication(services, fixture.Configuration());
    ...
    {
        foreach (var assembly in new[] { typeof(TenantOperation).Assembly, typeof(AdminAreaManagement.Core.Common.Entity).Assembly })
