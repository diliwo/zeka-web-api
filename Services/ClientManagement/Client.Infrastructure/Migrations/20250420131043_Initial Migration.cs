        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email_EmailAddress = table.Column<string>(type: "text", nullable: true),
                    Phone_PhoneNumber = table.Column<string>(type: "text", nullable: true),
                    MobilePhone_PhoneNumber = table.Column<string>(type: "text", nullable: true),
                    NativeLanguage_SpokenLanguage = table.Column<string>(type: "text", nullable: true),
                    ContactLanguage_SpokenLanguage = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProfessionnalExperienceId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessionnalExperience", x => x.ProfessionnalExperienceId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchoolRegistrations", x => x.SchoolRegistrationId);
                    table.ForeignKey(
