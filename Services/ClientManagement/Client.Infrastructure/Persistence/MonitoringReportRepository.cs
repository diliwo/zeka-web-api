...
{
    public class MonitoringReportRepository : IMonitoringReportRepository
    {
        private readonly ApplicationDbContext _context;
        public MonitoringReportRepository(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<int> Persist(MonitoringReport qMonitoringReport)
        {
            ...
            {
                _context.MonitoringReports.Add(qMonitoringReport);
